...
/**
 * Takes in {@link Long}s and lazily calculates the average 
 * on a given amount of the latest added numbers
 * @author LupCode.com (Luca Vogels)
 * @since 2021-01-14
 */
public class AverageLong extends Number {
	...
	/**
	 * Creates an {@link AverageLong} that calculates 
	 * the average on a given amount of received {@link Long}s
	 * @param capacity Amount of numbers that should be hold for calculation
	 */
	public AverageLong(int capacity) {
	...
	protected void checkAverage() {
		...
		for(long i : queue) this.average += i / size;
